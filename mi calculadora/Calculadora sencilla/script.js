...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function calcular(operacion) {
    ...
    if (operacion === 'add') r = a + b;        // Suma.
    else if (operacion === 'sub') r = a - b;   // Resta.
    else if (operacion === 'mul') r = a * b;   // Multiplicación.
    else if (operacion === 'div') r = a / b;   // divicion.
    else if (operacion === 'por') r = a / b * 100;   // porcentaje.
    else if (operacion === 'exp') r = a ** b;   // exponente.
    else if (operacion === 'igu') r = a == b;   // igual que.
    else if (operacion === 'may') r = a > b;   // mayor que.
     else if (operacion === 'men') r = a < b;   // menor que.
